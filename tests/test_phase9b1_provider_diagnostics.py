...
def test_workflow_is_only_commit_push_owner_and_stages_atomic_publication_outputs():
    scan_workflow = Path(".github/workflows/overnight_scan.yml").read_text(encoding="utf-8")
    workflow = Path(".github/workflows/atlas_full_qa_certification.yml").read_text(encoding="utf-8")
