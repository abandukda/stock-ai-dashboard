    ...
    *,
    ...
    if certified_customer and not report.get("customer_plain_english_summary"):
        ...
        guidance_input = {
            ...
            "revenue_growth_pct": field_value("revenue_growth_pct"), "eps_growth_pct": field_value("eps_growth_pct"),
            "gross_margin_pct": field_value("gross_margin_pct"), "operating_margin_pct": field_value("operating_margin_pct"),
