...
def build_ticker_context(row: Mapping[str, Any]) -> dict[str, Any]:
    ...
    return {
        ...
        "atlas_valuation_status": valuation["atlas_valuation_status"],
        "atlas_fv_upside_pct": _fmt_pct(valuation["atlas_fv_upside_pct"]),
        "analyst_consensus": _fmt_money(analyst_target),
        ...
        "operating_margin": _fmt_pct(_pick(row, "operating_profit_margin", "operating_margin", "Operating Margin")),
