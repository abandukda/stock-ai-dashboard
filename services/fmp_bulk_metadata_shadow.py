...
def _profile(row: Mapping[str, Any], fetched_at: str) -> dict[str, Any]:
    ...
    return {
        ...
        "is_delisted": _boolean(row.get("isDelisted")),
        "price": _number(row.get("price")),
        "volume": _number(row.get("volume")),
        "average_volume": _number(_first(row, "averageVolume", "avgVolume")),
        "security_subtype": _text(_first(row, "type", "securityType")),
...
def build_fmp_candidate_metadata(record: Mapping[str, Any]) -> dict[str, Any]:
    ...
    return {
        ...
        "security_subtype": profile.get("security_subtype"),
        ...
        "is_delisted": profile.get("is_delisted"),
