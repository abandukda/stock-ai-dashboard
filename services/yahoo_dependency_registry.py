...
LEGACY_STATUSES: Final = frozenset({LEGACY_APP_HELPER, OFFLINE_RESEARCH, BACKUP_ONLY})
...
YAHOO_DEPENDENCIES: Final[tuple[YahooDependency, ...]] = (
    ...
    _dependency("YAHOO_EXPLICIT_RESEARCH_ROW", "engines/live_research_engine.py", "build_live_research", "MIXED_RESEARCH_ROW", ("PROFILE", "STATEMENTS", "EARNINGS", "ANALYSTS", "VALUATION_INPUTS"), ("RESEARCH_CONTEXT_V1", "FMP_RESEARCH_ACQUISITION"), "FMP-FIRST.2", ACTIVE_PRIMARY, "IMMUTABLE_DECISION_AND_FAMILY_RUNTIME_QA", ("tk = yf.Ticker(symbol)", "info = tk.get_info()")),
    _dependency("YAHOO_EXPLICIT_RESEARCH_ACTIONS", "engines/live_research_engine.py", "fetch_analyst_action_history", "ANALYST_FIRM_ACTIONS", ("RESEARCH_ANALYST_CARDS",), ("FMP_GRADES", "TOP_ANALYST_ACTIONS_V1"), "FMP-FIRST.4", ACTIVE_PRIMARY, "DISTINCT_FIRM_PROVENANCE_QA", ("tk.upgrades_downgrades",)),
...
__all__ = [
    ...
    "EXPECTED_YAHOO_DEPENDENCY_COUNT_V1", "LEGACY_APP_HELPER", "LEGACY_STATUSES",
