...
def _full_evidence(card: Mapping[str, Any]) -> str:
    ...
    return (
        ...
        f'<span data-atlas-trade-segment="entry"><b>Entry</b> {html.escape(entry)}</span><i aria-hidden="true">·</i>'
        f'<span data-atlas-trade-segment="stop"><b>Stop</b> {html.escape(stop)}</span><i aria-hidden="true">·</i>'
