...
def _inject_css() -> None:
    ...
    body:has([data-atlas-qa="home-guidance-vnext"]) .stButton>button[kind="primary"]{min-height:2.05rem;height:2.05rem;padding:.2rem .7rem}
    ...
    @media(max-width:480px){body:has([data-atlas-qa="home-guidance-vnext"]) [data-testid="stMainBlockContainer"]{padding-top:.2rem!important}body:has([data-atlas-qa="home-guidance-vnext"]) [data-testid="stMainBlockContainer"]>[data-testid="stVerticalBlock"]{gap:.24rem!important}body:has([data-atlas-qa="home-guidance-vnext"]) [data-testid="stElementContainer"]:has([data-atlas-qa][aria-hidden="true"]){display:none!important}.atlas-home-guidance-hero{padding:.04rem 0 .11rem}.atlas-home-guidance-hero h1{font-size:1.5rem;line-height:1.08;margin:.02rem 0 .08rem}.atlas-home-guidance-hero p{margin:.08rem 0}.atlas-home-guidance-primary{grid-template-columns:1fr 1fr;gap:.18rem;margin:.01rem 0 .06rem}.atlas-home-guidance-primary span{padding:.17rem .3rem}.atlas-home-guidance-primary small{font-size:.55rem}.atlas-home-guidance-primary strong{font-size:.92rem}.atlas-home-guidance-core{grid-template-columns:repeat(3,minmax(0,1fr));gap:.03rem;margin:.01rem 0 .06rem}.atlas-home-guidance-core .atlas-home-guidance-metric{padding:.06rem .09rem}.atlas-home-guidance-core small{font-size:.53rem}.atlas-home-guidance-core b{font-size:.8rem}.atlas-home-guidance-status{gap:.02rem;margin:0 0 .04rem;padding:.06rem .03rem}.atlas-home-guidance-status .atlas-home-guidance-metric{padding:.06rem .05rem}.atlas-home-guidance-status small{font-size:.49rem}.atlas-home-guidance-status b{font-size:.62rem}.atlas-home-guidance-evidence{grid-template-columns:repeat(2,minmax(0,1fr))}h2{margin:.2rem 0!important;font-size:1.25rem!important;line-height:1.12!important}h3{font-size:1rem!important;line-height:1.06!important;margin:.01rem 0!important;padding:.03rem 0!important}.atlas-home-guidance-card-marker+div [data-testid="stVerticalBlock"]{gap:.05rem}body:has([data-atlas-qa="home-guidance-vnext"]) [data-testid="stExpander"] details summary{height:1.9rem!important;min-height:1.9rem!important;padding:.06rem .5rem!important}body:has([data-atlas-qa="home-guidance-vnext"]) [data-testid="stExpander"] details summary p{font-size:.74rem;white-space:nowrap}}
